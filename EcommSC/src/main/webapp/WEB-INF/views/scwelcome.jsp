	...
	<tiles:putAttribute name="body">
		<div class="body">
			...
			<div class="loginHelpLinks">
				<table>
					<tr>
						<td><spring:url value="/registerNewUser" var="registerNewUserUrl"
								htmlEscape="true" /> <a href="${registerNewUserUrl}" >Register As New User</a></td>
								<td style="width: 12px; "></td>
						<td><spring:url value="/forgotPassword" var="forgotPasswordUrl"
								htmlEscape="true" /> <a href="${forgotPasswordUrl}">Forgot Password</a></td>
					</tr>
				</table>
			</div>
