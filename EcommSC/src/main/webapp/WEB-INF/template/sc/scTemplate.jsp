...
<body>
	<div class="page">
		<tiles:insertAttribute name="scheader" />
		<tiles:insertAttribute name="scMenuTab"/>
		<div class="content">
			<tiles:insertAttribute name="scmenu" />
			<tiles:insertAttribute name="scbody" />
			<tiles:insertAttribute name="scRightPanel" />
		</div>
		<tiles:insertAttribute name="scfooter" />
	</div>
</body>
</html>